...
<head>
  ...
  <title>Profil Mahasiswa - Taufiq Hidayat</title>
  <meta name="description" content="Profil pribadi Taufiq Hidayat Mahasiswa Akuntansi." />
  ...
  <style>
    ...
    body{font-family:Inter,ui-sans-serif; background:var(--bg); color:#06acca; scroll-behavior:smooth}
    ...
    .accent-underline{background:linear-gradient(90deg,var(--accent),#058d8a);height:4px;border-radius:999px}
    .glass-btn{background:rgba(255,255,255,0.05);border:1px solid rgba(255, 255, 255, 0.463);padding:.6rem 1rem;border-radius:10px;display:inline-flex;align-items:center;gap:.5rem}
    .floaty{animation:float 6s ease-in-out infinite}
    @keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-12px)}}
    .glow{box-shadow:0 0 25px rgba(12, 165, 153, 0.7)}
...
<body class="antialiased leading-relaxed">
  ...
  <main class="max-w-6xl mx-auto px-6 pt-16 relative z-10">
    ...
    <section id="beranda" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-screen">
      <div>
        <h1 class="mt-3 text-4xl sm:text-5xl font-extrabold leading-tight reveal">Halo, saya <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-300">Taufiq Hidayat</span></h1>
        <p class="mt-4 text-slate-300 max-w-xl reveal">Saya mahasiswa Akuntansi yang tertarik dengan dunia bisnis.</p>
    ...
    <section id="pendidikan" class="mt-16">
      ...
      <div class="space-y-4">
        <div class="frost p-4 rounded-xl reveal">
          ...
          <p class="text-sm text-slate-300">Menempuh S1 Akuntansi - Sekarang</p>
        </div>
        <div class="frost p-4 rounded-xl reveal">
          <h4 class="font-semibold">SMK Darul Ulum Banyuanyar</h4>
          <p class="text-sm text-slate-300">Jurusan Perbankan Syariah — 2021 - 2024</p>
        </div>
        <div class="frost p-4 rounded-xl reveal">
          <h4 class="font-semibold">SMPI At-Tablighiyah</h4>
    ...
    <section id="hobi" class="mt-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="frost p-6 rounded-xl reveal">
          <ul class="list-disc list-inside space-y-2 text-slate-300">
            <li>Bermain Badminton olahraga ringan</li>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="frost p-6 rounded-xl reveal">
          ...
          <ul class="mt-4 text-sm text-slate-300 space-y-2">
            <li><i class="fa-solid fa-envelope"></i> Email: <strong>hidayat112304@example.com</strong></li>
            <li><i class="fa-solid fa-phone"></i> Telepon: <strong>+62 859-6109-0285</strong></li>
          </ul>
          <div class="mt-4 flex gap-2 flex-wrap">
            <a href="https://www.instagram.com/maz_afick2" target="_blank" class="glass-btn"><i class="fa-brands fa-instagram"></i> Instagram</a>
            <a href="https://www.tiktok.com/@maz_afick" target="_blank" class="glass-btn"><i class="fa-brands fa-tiktok"></i> TikTok</a>
            <a href="https://wa.me/6285961090285" target="_blank" class="glass-btn"><i class="fa-brands fa-whatsapp"></i> WhatsApp</a>
          </div>
        </div>
  ...
  <footer class="text-center text-sm text-slate-400 pb-12">© <span id="year"></span> Taufiq Hidayat.</footer>
